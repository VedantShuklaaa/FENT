...
export default function Footer() {
    ...
    return (
        <motion.footer
            ref={ref}
            className="w-full overflow-hidden border-t-[0.5px] border-t-[rgba(255,255,255,0.07)] dark:bg-[#111410]"
        ...
        >
            ...
            <div className="mx-auto grid max-w-[1400px] grid-cols-[minmax(0,2fr)_minmax(0,1fr)] gap-0 px-10 py-12">
                <div className="flex flex-col gap-10 border-r-[0.5px] border-r-[rgba(255,255,255,0.07)] pr-12">
                    <FooterBrand />
                    <div className="h-[0.5px] bg-[rgba(255,255,255,0.07)]" aria-hidden />
                    <FooterLinks />
                </div>
